...
# print(control_data.avg_c[1])
# print(increase_eyes_data.avg_ie[1])
# print(increase_jawline_data.avg_ij[1])
# print(decrease_eyes_data.avg_de[1])
# print(decrease_jawline_data.avg_dj[1])

# increase eyes
prior = control_data.avg_c[1]
likelihood = increase_eyes_data.avg_ie[1]
marginal = likelihood*prior + (1-likelihood)*(1-prior)
posterior = likelihood*prior/marginal
# print(posterior)

print(control_data.score_avg_c1/7)
# #P(attractive) = control
# p_attr = []
# for i in range(8):
#     p_attr.append(control_data.avg_c[i]/7)

# #P(feature | attractive) = likelihood 
# p_like_ie = []
# for i in range(8):
#     p_like_ie.append((increase_eyes_data.avg_ie[i]/7)*p_attr[i])

# #P(feature) = sum of likelihood
# p_marg_ie = sum(p_like_ie)

# print(p_attr, p_like_ie, p_marg_ie)
